            ...
            row.innerHTML = `
                ...
                <td>
                    <div class="action-buttons">
                        <button class="btn-action btn-edit" title="Editar" onclick="Categorias.mostrarModal(${cat.id})"><i class="fas fa-edit"></i></button>
                        <button class="btn-action ${cat.activo ? 'btn-toggle-off' : 'btn-toggle-on'}" title="${cat.activo ? 'Desactivar' : 'Activar'}" onclick="Categorias.cambiarEstado(${cat.id},${cat.activo})">
                            <i class="fas fa-${cat.activo ? 'ban' : 'check-circle'}"></i>
                        </button>
                        <button class="btn-action btn-delete" title="Eliminar" onclick="Categorias.eliminar(${cat.id},'${cat.nombre.replace(/'/g, "\\'")}',${cant})">
