            ...
            row.innerHTML = `
                ...
                <td>
                    <div class="action-buttons">
                        <button class="btn-action btn-edit" title="Editar" onclick="Productos.mostrarModal('${p.id}')">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn-action ${activo ? 'btn-toggle-off' : 'btn-toggle-on'}" title="${activo ? 'Desactivar' : 'Activar'}"
                            onclick="Productos.cambiarEstado('${p.id}','${p.nombre.replace(/'/g, "\\'")}',${activo})">
                            <i class="fas fa-${activo ? 'ban' : 'check-circle'}"></i>
                        </button>
                        <button class="btn-action btn-delete" title="Eliminar" onclick="Productos.eliminar('${p.id}','${p.nombre.replace(/'/g, "\\'")}')">
