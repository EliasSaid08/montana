    ...
    async function cargarSeccion() {
        ...
        lista.forEach(c => {
            ...
            row.innerHTML = `
                ...
                <td>
                    <button class="btn-secondary" style="padding:6px 12px;margin-right:5px;" title="Ver ficha del cliente" onclick="Clientes.verFichaCliente(${c.id})">
            ...
            modal.innerHTML = `
                <div class="modal-content" style="max-width:700px;">
                    <div class="modal-header">
                        <h3><i class="fas fa-history" style="margin-right:8px;"></i>Historial de Pagos — ${cliente?.nombre || ''}</h3>
                        <button class="close-modal" onclick="document.getElementById('historialPagosModal').remove()">&times;</button>
                    </div>
                    <div class="card-body">
        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width:900px;max-height:90vh;overflow-y:auto;">
                <div class="modal-header" style="position:sticky;top:0;z-index:10;background:var(--bg-card);">
                    ...
                    <button class="close-modal" onclick="document.getElementById('fichaClienteModal').remove()">&times;</button>
                </div>
