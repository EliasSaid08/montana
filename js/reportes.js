const Reportes = (() => {
        ...
        try {
            ...
            deudores.forEach(d => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <button class="btn-primary" style="padding:5px 10px;font-size:12px;" onclick="Clientes.mostrarModalPago(${d.id},'${d.nombre.replace(/'/g, "\\'")}',${d.deuda_total})">
    ...
    return { cargar, renderizarGraficaVentas, exportarVentas, exportarStockBajo, exportarMorosos, cargarMorosos };
})();
